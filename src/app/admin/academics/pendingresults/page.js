  ...
  const handleApproval = async (e, index) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert(data.message || "Failed href update results.");
      }
    } catch (error) {
  ...
  const handleDeleteResult = async (e, index) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const data = await response.json();
        alert(data.message || "Failed href delete result.");
      }
    } catch (error) {
                            ...
                            <td>
                              <button
                                ...
                                onClick={(e) => {
                                  ...
                                  handleSaveResults(e, index);
                                }}
                                className="btn btn-primary w-100 mb-1"
                                disabled={saveLoadingId === student.id}>
                                {saveLoadingId === student.id ? (
                                  <>
                                    <span
                                      className="spinner-border spinner-border-sm me-2"
                                      role="status"
